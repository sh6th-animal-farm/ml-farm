				...
				<div class="form-card">
					...
					<div class="grid-3">
						<div class="form-group">
							<label>농장 선택 (Farm ID)</label> <select name="farm_id" required>
								<option value="">농장을 선택하세요</option>
								<option value="1">청라 스마트팜</option>
							</select>
						</div>
						<div class="form-group">
							<label>프로젝트 명</label> <input type="text" name="project_name"
								required>
						</div>
						<div class="form-group">
							<label>프로젝트 차수 (Round)</label> <input type="number"
								name="project_round" value="1" required>
						</div>
