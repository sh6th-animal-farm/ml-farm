...
var options = { //지도를 생성할 때 필요한 기본 옵션
	center: new kakao.maps.LatLng(37.5432394, 126.988300), //지도의 중심좌표.
...
// 마커
var content = '<div style="width:24px; height:24px; background:#fff; border:3px solid #4A9F2E; border-radius:50%;"></div>';
